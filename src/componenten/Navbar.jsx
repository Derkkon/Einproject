  ...
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
      <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border bg-yellow-300 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-yellow-300">
        ...
        <li>
          <a href={'https://scduffel.shop4clubs.eu/'} target={"_blank"} rel={"noreferrer"} className="block pl-3 pr-4 text-red-600 hover:text-white hover:bg-red-600 rounded-md px-3 py-2 text-md font-medium">Kij</a>
        </li>
      </ul>
    </div>
  </div>
