...
const Navbar = () => {
  ...
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <a href={'/signIn'}>
      <button className="flex justify-center text-3xl text-red-600 hover:text-white hover:bg-red-600 rounded-md px-3 py-2 text-md font-medium"><IoIosPerson /></button>
    </a>
