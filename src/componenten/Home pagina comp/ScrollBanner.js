...
const ScrollBanner = () => {
    return (
        <div className="sponsor-slider mt-3">
            <div className="flex flex-no-wrap sponsor-banner">
                <a href='https://www.carrefour.be/nl.html' target={"_blank"} rel={"noreferrer"}>
                    <img src={sponor1} className="w-20 md:w-40 lg:w-40 ml-40 grayscale hover:grayscale-0" alt={'Carrefour'} />
                </a>
                <a href='https://www.jako.be/nl/' target={"_blank"} rel={"noreferrer"}>
                    <img src={sponor2} className="w-20 md:w-40 lg:w-40 ml-40 grayscale hover:grayscale-0" alt={'Jako'} />
                </a>
                <a href='https://www.kbc.be/particulieren/nl.html' target={"_blank"} rel={"noreferrer"}>
                    <img src={sponor3} className="w-20 md:w-40 lg:w-40 ml-40 grayscale hover:grayscale-0" alt={'KBC'} />
                </a>
                <a href='https://www.nike.com/be/' target={"_blank"} rel={"noreferrer"}>
                    <img src={sponor4} className="w-20 md:w-40 lg:w-40 ml-40 grayscale hover:grayscale-0" alt={'Nike'} />
                </a>
            </div>
        </div>
    )
